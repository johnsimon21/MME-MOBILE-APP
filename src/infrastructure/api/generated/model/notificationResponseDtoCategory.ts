 ...
 */
export type NotificationResponseDtoCategory =
  (typeof NotificationResponseDtoCategory)[keyof typeof NotificationResponseDtoCategory];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationResponseDtoCategory = {
  session: "session",
  message: "message",
  call: "call",
  system: "system",
