 ...
 */
import type { TicketsUpdateTicketStatusBodyStatus } from "./ticketsUpdateTicketStatusBodyStatus";

export type TicketsUpdateTicketStatusBody = {
  status: TicketsUpdateTicketStatusBodyStatus;
  reason?: string;
};
