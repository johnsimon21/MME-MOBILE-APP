...
export type DashboardGetUserAnalyticsSortBy =
  (typeof DashboardGetUserAnalyticsSortBy)[keyof typeof DashboardGetUserAnalyticsSortBy];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DashboardGetUserAnalyticsSortBy = {
  name: "name",
