...
export type SupportChatGetChatSessionsStatus =
  (typeof SupportChatGetChatSessionsStatus)[keyof typeof SupportChatGetChatSessionsStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SupportChatGetChatSessionsStatus = {
  active: "active",
  closed: "closed",
  waiting: "waiting",
} as const;
