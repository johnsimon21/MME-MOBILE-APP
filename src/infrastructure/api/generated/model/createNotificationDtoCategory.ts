 ...
 */
export type CreateNotificationDtoCategory =
  (typeof CreateNotificationDtoCategory)[keyof typeof CreateNotificationDtoCategory];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateNotificationDtoCategory = {
  session: "session",
  message: "message",
  call: "call",
  system: "system",
