...
export type SessionsFindSessionsStatus =
  (typeof SessionsFindSessionsStatus)[keyof typeof SessionsFindSessionsStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SessionsFindSessionsStatus = {
  scheduled: "scheduled",
  active: "active",
  completed: "completed",
  cancelled: "cancelled",
