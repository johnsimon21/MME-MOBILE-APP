 ...
 */
import type { SupportChatGetChatSessionsStatus } from "./supportChatGetChatSessionsStatus";

export type SupportChatGetChatSessionsParams = {
  page?: number;
  limit?: number;
  status?: SupportChatGetChatSessionsStatus;
};
