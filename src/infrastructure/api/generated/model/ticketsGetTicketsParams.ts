 ...
 */
import type { TicketsGetTicketsPriority } from "./ticketsGetTicketsPriority";
import type { TicketsGetTicketsStatus } from "./ticketsGetTicketsStatus";

export type TicketsGetTicketsParams = {
  search?: string;
  category?: string;
  priority?: TicketsGetTicketsPriority;
  status?: TicketsGetTicketsStatus;
  limit?: number;
  page?: number;
};
