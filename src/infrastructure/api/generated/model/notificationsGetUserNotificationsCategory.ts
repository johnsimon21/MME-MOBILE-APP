...
export type NotificationsGetUserNotificationsCategory =
  (typeof NotificationsGetUserNotificationsCategory)[keyof typeof NotificationsGetUserNotificationsCategory];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationsGetUserNotificationsCategory = {
  session: "session",
  message: "message",
  call: "call",
  system: "system",
