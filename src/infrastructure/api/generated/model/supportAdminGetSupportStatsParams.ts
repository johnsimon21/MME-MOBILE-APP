 ...
 */
import type { SupportAdminGetSupportStatsPeriod } from "./supportAdminGetSupportStatsPeriod";

export type SupportAdminGetSupportStatsParams = {
  /**
   * Período para as estatísticas
   */
  period?: SupportAdminGetSupportStatsPeriod;
};
