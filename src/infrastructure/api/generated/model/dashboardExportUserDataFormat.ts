...
export type DashboardExportUserDataFormat =
  (typeof DashboardExportUserDataFormat)[keyof typeof DashboardExportUserDataFormat];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DashboardExportUserDataFormat = {
  csv: "csv",
  excel: "excel",
} as const;
