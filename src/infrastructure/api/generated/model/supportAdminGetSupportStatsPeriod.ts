...
export type SupportAdminGetSupportStatsPeriod =
  (typeof SupportAdminGetSupportStatsPeriod)[keyof typeof SupportAdminGetSupportStatsPeriod];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SupportAdminGetSupportStatsPeriod = {
  day: "day",
  week: "week",
  month: "month",
  year: "year",
