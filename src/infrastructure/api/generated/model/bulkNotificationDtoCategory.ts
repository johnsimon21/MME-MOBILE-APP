 ...
 */
export type BulkNotificationDtoCategory =
  (typeof BulkNotificationDtoCategory)[keyof typeof BulkNotificationDtoCategory];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BulkNotificationDtoCategory = {
  session: "session",
  message: "message",
  call: "call",
  system: "system",
