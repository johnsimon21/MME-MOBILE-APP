...
export type NotificationsGetUserNotificationsPriority =
  (typeof NotificationsGetUserNotificationsPriority)[keyof typeof NotificationsGetUserNotificationsPriority];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationsGetUserNotificationsPriority = {
  low: "low",
  medium: "medium",
  high: "high",
  urgent: "urgent",
