...
export type DashboardGetUserAnalyticsStatus =
  (typeof DashboardGetUserAnalyticsStatus)[keyof typeof DashboardGetUserAnalyticsStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DashboardGetUserAnalyticsStatus = {
  online: "online",
  offline: "offline",
  all: "all",
} as const;
