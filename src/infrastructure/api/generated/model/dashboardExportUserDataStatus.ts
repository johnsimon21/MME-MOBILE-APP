...
export type DashboardExportUserDataStatus =
  (typeof DashboardExportUserDataStatus)[keyof typeof DashboardExportUserDataStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DashboardExportUserDataStatus = {
  online: "online",
  offline: "offline",
  all: "all",
} as const;
